...
LM(1, MOD_LSFT), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                                KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_EQL,
    ...
    [2] = LAYOUT_split_3x6_3(
        TO(0),    KC_MUTE, KC_TRNS, KC_UP,   KC_TRNS,   TG(2),                                KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,
